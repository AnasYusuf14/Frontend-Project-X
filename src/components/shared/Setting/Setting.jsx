  ...
  export default function Setting() {
    ...
    useEffect(() => {
      const pathMap = {
        ...
        "/setting/account": { path: "/setting/account", item: t('settings.yourAccount') },
        ...
        <div className="grow w-full h-full flex flex-col gap-2 max-w-[800px]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <SettingListItem
              ...
              onClick={() => handleNavigation(t('settings.yourAccount'), "/setting/account")}
            />
            <SettingListItem
              ...
              onClick={() =>
                handleNavigation(t('settings.monetization'), "/setting/monetization")
              }
            />
            <SettingListItem
            ...
            <SettingListItem
              ...
              onClick={() =>
                handleNavigation(t('settings.notifications'), "/setting/notifications")
              }
            />
            <SettingListItem
              title={t('settings.accessibilityDisplayAndLanguages')}
              icon={<MdKeyboardArrowRight />}
              isActive={selectedItem === t('settings.accessibilityDisplayAndLanguages')}
              onClick={() =>
                handleNavigation(
