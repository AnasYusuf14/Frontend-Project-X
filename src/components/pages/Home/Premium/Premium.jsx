  ...
  return (
    <div className="py-10 px-4">
      ...
      <div className="flex justify-around flex-wrap">
        <div className="bg-[#202327] rounded-lg shadow-lg p-5 w-64 mb-3 lg:mb-0">
        ...
        <div className="bg-[#202327] border border-[#1d9bf0] rounded-lg shadow-lg p-5 w-64 mb-3 lg:mb-0">
